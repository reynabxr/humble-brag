    ...
    >
      <div className="text-center space-y-8">
        ...
        <div className="space-y-2">
          ...
          >
            Creating Your {isMovie ? "movie" : "Highlight Reel"}
          </h2>
          <p className="text-white/80 text-lg h-7 transition-opacity duration-200">
          ...
          {[0, 1, 2].map((i) => (
            <div
              ...
              className={cn(
                ...
                isMovie ? "bg-movie-gold" : "bg-sports-green",
              )}
